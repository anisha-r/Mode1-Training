...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.anisha.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.25:8080/SOAPWebServiceDemo/services/Calculator";
    ...
    public com.anisha.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.anisha.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.anisha.CalculatorSoapBindingStub _stub = new com.anisha.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.anisha.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.anisha.CalculatorSoapBindingStub _stub = new com.anisha.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://anisha.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://anisha.com", "Calculator"));
        }
