...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.hcl.name.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://127.0.0.1:8181/helloworld";
    ...
    public com.hcl.name.HelloWorld getHelloWorldPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.hcl.name.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.name.HelloWorldPortBindingStub _stub = new com.hcl.name.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.name.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.name.HelloWorldPortBindingStub _stub = new com.hcl.name.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://name.hcl.com/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://name.hcl.com/", "HelloWorldPort"));
        }
