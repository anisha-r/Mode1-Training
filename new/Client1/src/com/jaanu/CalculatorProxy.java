...
public class CalculatorProxy implements com.jaanu.Calculator {
  private String _endpoint = null;
  private com.jaanu.Calculator calculator = null;
  ...
  private void _initCalculatorProxy() {
    try {
      calculator = (new com.jaanu.CalculatorServiceLocator()).getCalculator();
      if (calculator != null) {
        if (_endpoint != null)
  ...
  public com.jaanu.Calculator getCalculator() {
    if (calculator == null)
      _initCalculatorProxy();
    return calculator;
  }
  ...
  public int multi(int num1, int num2) throws java.rmi.RemoteException{
    if (calculator == null)
      _initCalculatorProxy();
    return calculator.multi(num1, num2);
  }
