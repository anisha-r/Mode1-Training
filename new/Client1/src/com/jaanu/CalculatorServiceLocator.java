...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.jaanu.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.2:8191/SOAPWebserviceDemo/services/Calculator";
    ...
    public com.jaanu.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jaanu.CalculatorSoapBindingStub _stub = new com.jaanu.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jaanu.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jaanu.CalculatorSoapBindingStub _stub = new com.jaanu.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jaanu.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jaanu.com", "Calculator"));
        }
