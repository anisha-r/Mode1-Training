...
%>
<form method="get" action="UpdateDepart.jsp">
   <center>
        Department No:
       <input type="text" name="deptno" readonly="readonly" value=<%=rs.getString("deptno") %> /><br/><br/>
         Department Name:
  ...
  <%
   if(request.getParameter("deptno") != null && request.getParameter("head") != null ) {
	   cmd="Update department set dname=?, loc=?,head=? "
			   + "where deptno=?";
